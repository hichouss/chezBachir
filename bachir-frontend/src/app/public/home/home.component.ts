...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  allProducts: FeaturedProduct[][] = [
    [
      ...
      { id: 3, name: 'Flanchet de bœuf', unit: 'au kg',    price: 14.99, imageUrl: '/Flank Steak_Trimmed.jpg', isPromo: true, offer: '3 kg = 41,99 €', saving: 'Économisez 3 €' },
      { id: 4, name: 'Plat de côte',     unit: 'au kg',    price: 15.99, imageUrl: '/plat-de-cote-de-boeuf.jpg', isPromo: true, offer: '3 kg = 44,99 €', saving: 'Économisez 3 €' },
    ],
    [
      ...
      { id: 7, name: 'Cuisses de poulet', unit: 'au kg',    price: 5.99,  imageUrl: '/cuisses-de-poulet-cru-avec-peau-sur-fond-blanc-220856755.webp', isPromo: true, offer: 'Carton 10 kg = 25,99 €', saving: 'Soit 2,60 €/kg' },
      { id: 8, name: 'Blanc de poulet',   unit: 'au kg',    price: 12.99, imageUrl: '/9812117-blanc-de-poulet-cru-gratuit-photo.jpg', isPromo: true, offer: 'Barquette 2,5 kg = 23,99 €', saving: 'Soit 9,60 €/kg' },
    ],
    [
      ...
      { id: 11, name: 'Ailes de poulet', unit: 'au kg',    price: 6.99,  imageUrl: '/45232932-raw-chicken-wings-isolated-on-white-background.jpg', isPromo: true, offer: 'Carton 3 kg = 15 €', saving: 'Soit 5 €/kg' },
